...
function DigitalWalletContent() {
  ...
  return (
    <div className="min-h-[100dvh] bg-gradient-to-b from-[#EEF4FB] to-[#F5F5EE] font-inter pb-12 relative">
      {/* Header */}
      <div className="pt-10 px-6 flex items-center gap-2 relative z-10">
        <button
          onClick={() => router.back()}
      ...
      <div className="px-6 mt-8 flex flex-col gap-6 max-w-md mx-auto">
        {/* Order Summary */}
        ...
        <button
          ...
          className="w-full bg-white rounded-[24px] p-5 shadow-sm border border-gray-100 flex items-center justify-between hover:shadow-md hover:border-red-100 active:scale-[0.98] transition-all duration-200"
        >
          <div className="flex items-center gap-4">
            {/* Vodafone red icon */}
            ...
            <div className="text-left">
              ...
              <p className="text-[13px] font-medium text-gray-400">Pay using your Vodafone wallet</p>
            </div>
          </div>
        ...
        <button
          ...
          className="w-full bg-white rounded-[24px] p-5 shadow-sm border border-gray-100 flex items-center justify-between hover:shadow-md hover:border-green-100 active:scale-[0.98] transition-all duration-200"
        >
          <div className="flex items-center gap-4">
            {/* Fawry green icon */}
            ...
            <div className="text-left">
              ...
              <p className="text-[13px] font-medium text-gray-400">Pay at any Fawry agent or online</p>
            </div>
          </div>
          <ChevronRight size={22} strokeWidth={2.5} className="text-gray-300" />
        </button>
