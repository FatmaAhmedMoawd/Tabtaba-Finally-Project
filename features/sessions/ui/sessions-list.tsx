...
export function SessionsList() {
  ...
  if (showGetReady) {
    return (
      <div className="flex flex-col min-h-screen bg-gradient-to-b from-[#FAFBFD] to-[#FFFFFF] font-sans max-w-lg lg:max-w-xl mx-auto pb-16 px-6 relative">
        ...
        <div className="bg-white rounded-[32px] p-5.5 shadow-[0_15px_35px_-5px_rgba(0,0,0,0.025),_0_5px_15px_rgba(0,0,0,0.01)] border border-slate-100/80 mt-6 flex flex-col gap-4.5">
          ...
          {/* Row 2: Grid Dates/Times - styled similarly */}
        ...
        {/* Citations Quote text strictly centered like the image */}
  ...
  if (isSubscribed && showJourney) {
    ...
    return (
      <div className="flex flex-col min-h-screen bg-gradient-to-b from-[#EFFAF3] via-[#FAFDFB] to-[#FCFAF6] font-inter max-w-lg lg:max-w-xl mx-auto pb-32 relative px-5">
          ...
          <div className="bg-gradient-to-b from-[#E7F6ED] to-[#F1FAF4] rounded-[32px] p-6 shadow-sm border border-white relative overflow-hidden">
            ...
            <div className="flex justify-between items-start mb-6">
              <div>
                ...
                <p className="text-[14px] text-gray-500 font-bold mt-1">March Path to Wellbeing</p>
              </div>
            ...
            <div className="relative flex justify-between items-center mt-8 pb-3 px-1">
              ...
              <div className="flex flex-col items-center flex-1 text-center relative z-10 opacity-60">
                ...
                <span className="text-[12px] font-black text-gray-500 mt-3 block">Session 4</span>
        ...
        <div className="mt-6">
          <div className="bg-white rounded-[32px] p-8 border border-gray-100/60 shadow-[0_12px_45px_rgba(0,0,0,0.03)] relative overflow-hidden flex flex-col">
            ...
            <div className="relative z-10">
              ...
              <p className="text-[18px] font-[600] text-gray-400 mb-8 flex items-center gap-1.5">
              ...
              <div className="flex gap-4 items-center">
                ...
                <button 
                  onClick={() => router.push('/calendar')}
                  className="w-[60px] h-[60px] rounded-[22px] border-2 border-gray-100 flex items-center justify-center text-gray-400 hover:bg-gray-50 hover:text-gray-600 active:scale-95 transition-all shrink-0 shadow-sm"
                >
        ...
        <div className="flex flex-col items-center justify-center mt-12 gap-1.5 opacity-60">
          <p className="text-[11px] text-gray-400 font-bold uppercase tracking-widest text-center">Development Settings</p>
          <button 
            onClick={() => {
              if (typeof window !== 'undefined') {
                localStorage.setItem('isSubscribed', 'false');
            ...
            className="text-[13px] text-[#0D7A39] font-black underline hover:text-[#00AC49] transition-colors leading-tight"
          >
  ...
  return (
    <div className="flex flex-col min-h-screen bg-[#F8FBFC] font-inter max-w-lg lg:max-w-xl mx-auto pb-24 px-5">
      ...
      {showFiveSecAlert && (
        <div className="fixed inset-0 z-[1000001] flex items-center justify-center p-4">
          ...
          <div className="relative bg-white rounded-[32px] w-full max-w-[350px] p-6 shadow-2xl border border-emerald-50 overflow-hidden transform animate-in fade-in zoom-in-95 duration-200">
            {/* Soft ambient background bubble decoration */}
